...
add_comfyui_directory_to_sys_path()
# Import utils first to avoid namespace conflicts
import utils
...
class CodeGenerator:
    ...
    def assemble_python_code(
        ...
        try:
            ...
            print(f"Warning: Black formatting failed ({e}), using unformatted code")
            # Code will work fine without black formatting
